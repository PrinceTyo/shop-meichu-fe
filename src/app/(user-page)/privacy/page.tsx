...
export const metadata = {
    title: "Privacy Policy — Maya-theme-empower",
    description:
        "Privacy Policy for Maya-theme-empower (maya-theme-empower.myshopify.com). Last updated: March 10, 2025.",
};
    ...
    return (
        <main className="min-h-screen bg-white text-black">
            <section className="max-w-6xl mx-auto py-18">
                ...
                {/* TITLE */}
                <h1 className="text-center text-6xl md:text-7xl font-extrabold mb-12">
                    Privacy policy
                </h1>
                ...
                <div className="prose prose-lg max-w-none mb-10">
                    ...
                    <p>
                        This Privacy Policy describes how Maya-theme-empower (the "Site", "we",
                        "us", or "our") collects, uses, and discloses your personal information when you visit,
                        use our services, or make a purchase from maya-theme-empower.myshopify.com (the "Site")
                        or otherwise communicate with us regarding the Site (collectively, the "Services").
                    ...
                    <p>
                        ...
                        Policy. If you do not agree to this Privacy Policy, please do not use or access any of the Services.
                    </p>
                </div>
                ...
                <div className="mb-8 prose max-w-none">
                    <p>
                        ...
                        Privacy Policy on the Site, update the "Last updated" date and take any other steps required
                        by applicable law.
                    </p>
                </div>

                {/* HOW WE COLLECT */}
                <h2 className="text-3xl font-bold mt-8 mb-4">How We Collect and Use Your Personal Information</h2>
                <div className="mb-8 prose max-w-none">
                    <p>
                        To provide the Services, we collect and have collected over the past 12 months personal
                        information about you from a variety of sources, as set out below. The information that we
                    ...
                    <p>
                        ...
                        communicate with you, provide or improve the Services, comply with any applicable legal obligations,
                        enforce any applicable terms of service, and to protect or defend the Services, our rights, and
                        the rights of our users or others.
                    </p>
                </div>

                {/* WHAT PERSONAL INFORMATION */}
                <h2 className="text-3xl font-bold mt-8 mb-4">What Personal Information We Collect</h2>
                <div className="prose max-w-none mb-8">
                    <h3 className="text-xl font-semibold">Information We Collect Directly from You</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold mt-4">Information We Collect about Your Usage</h3>
                    <p>
                        We may also automatically collect certain information about your interaction with the Services ("Usage Data").
                        To do this, we may use cookies, pixels and similar technologies ("Cookies"). Usage Data may include information
                    ...
                    <h3 className="text-xl font-semibold mt-4">Information We Obtain from Third Parties</h3>
                    <p>
                        Finally, we may obtain information about you from third parties, including from vendors and service providers
                        who may collect information on our behalf, such as:
                    </p>
                    <ul className="list-disc pl-6">
                ...
                <ul className="prose max-w-none mb-8 list-disc pl-6">
                    <li>
                ...
                {/* HOW WE DISCLOSE */}
                <h2 className="text-3xl font-bold mt-8 mb-4">How We Disclose Personal Information</h2>
                ...
                {/* TABLE 1 */}
                <div className="border border-gray-300 w-full text-[15px] leading-relaxed">
                    {/* Header */}
                    <div className="grid grid-cols-2 border-b border-gray-300">
                        <div className="p-4 font-semibold border-r border-gray-300">
                            Category
                        </div>
                        ...
                        <div className="p-4 border-r border-gray-300">
                            <ul className="list-disc ml-5 space-y-2">
                                ...
                                <li>
                                    ...
                                    Records statute such as basic contact details and certain order and
                                    account information
                                </li>
                                <li>
                                ...
                                <li>
                                    Geolocation data such as locations determined by an IP address or
                ...
                {/* TABLE 2 */}
                <div className="mb-10 border border-gray-300 w-full text-[15px] leading-relaxed">
                    {/* HEADER */}
                    <div className="grid grid-cols-2 border-b border-gray-300">
                        <div className="p-4 font-semibold border-r border-gray-300">
                ...
                {/* THIRD PARTY LINKS */}
                <h2 className="text-3xl font-bold mt-8 mb-4">Third Party Websites and Links</h2>
                <div className="prose max-w-none mb-8">
                    <p>
                ...
                {/* CHILDREN */}
                <h2 className="text-3xl font-bold mt-8 mb-4">Children's Data</h2>
                <div className="prose max-w-none mb-8">
                    <p>
                ...
                {/* SECURITY & RETENTION */}
                <h2 className="text-3xl font-bold mt-8 mb-4">Security and Retention of Your Information</h2>
                <div className="prose max-w-none mb-8">
                    <p>
                ...
                {/* COMPLAINTS */}
                <h2 className="text-3xl font-bold mt-8 mb-4">Complaints</h2>
                <div className="prose max-w-none mb-8">
                    <p>
                ...
                {/* INTERNATIONAL USERS */}
                <h2 className="text-3xl font-bold mt-8 mb-4">International Users</h2>
                <div className="prose max-w-none mb-8">
                    <p>
                ...
                <div className="prose max-w-none mb-16">
                    <p>
                        Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at maya.support@shinedezign.com
                    </p>
                </div>

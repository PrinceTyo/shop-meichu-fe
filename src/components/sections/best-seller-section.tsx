        ...
        <div className="md:absolute inset-0 px-4 pt-20 flex pointer-events-none z-20">
          <div className="w-full md:w-1/2 space-y-4 mt-0 md:mt-10 lg:mt-0">
            ...
            <p className="text-white font-inter text-xs">
              There was something about you that now I can't remember It's the
              same damn thing that made my heart surrender And I'll miss you on
              a train I'll miss you in the morning, I never know what to think
              about, so think about you
            </p>
          </div>
        </div>
